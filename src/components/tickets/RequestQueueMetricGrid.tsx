  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
      ...
      <Card>
        ...
        <CardContent className="px-3 pb-3">
          <p className="text-xl font-semibold">{metrics.unassigned}</p>
      ...
      <Card>
        ...
        <CardContent className="px-3 pb-3">
          <p className="text-xl font-semibold">{metrics.slaBreached}</p>
      ...
      <Card>
        ...
        <CardContent className="px-3 pb-3">
          <p className="text-xl font-semibold">{metrics.slaAtRisk}</p>
      ...
      <Card>
        ...
        <CardContent className="px-3 pb-3">
          <p className="text-xl font-semibold">{metrics.awaitingApproval}</p>
