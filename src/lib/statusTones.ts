/**
 * Centralized status / badge tone classes.
 *
 * Retires the ~10 duplicated colour maps scattered across module pages. New code
 * should import `toneClass(tone)` instead of hand-writing bg/text colour pairs.
 * Existing pages can migrate incrementally as they are touched.
 */
