...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "admin/suppliers", element: <RequireRole roles={ADMIN_ONLY}><R scope="Suppliers"><S><Suppliers /></S></R></RequireRole> },
      { path: "admin/dealers", element: <RequireRole roles={ADMIN_ONLY}><R scope="Dealers"><S><Dealers /></S></R></RequireRole> },
      { path: "admin/user-groups", element: <RequireRole roles={ADMIN_ONLY}><R scope="User Groups"><S><UserGroups /></S></R></RequireRole> },
