...
export interface MetricCardProps {
  ...
  tone?: Tone;
  /** Optional trend delta. Direction drives colour + arrow. */
  delta?: { value: string; direction: 'up' | 'down' | 'flat'; label?: string };
  onClick?: () => void;
  /** Render as a router link target instead of a button. */
  loading?: boolean;
  className?: string;
  'data-testid'?: string;
}
 ...
 * Mirrors the suite's shared primitive so the HRMS workspace shares its look.
 */
