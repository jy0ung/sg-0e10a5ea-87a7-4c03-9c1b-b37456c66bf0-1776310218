...
export const PLATFORM_ROUTES: readonly PlatformRouteDefinition[] = [
  ...
  { id: 'portal-manager-dashboard', label: 'Manager Dashboard', path: '/portal/dashboard', shell: 'portal', section: 'Internal Requests', icon: 'layout-dashboard', moduleGate: 'support', roles: ['super_admin', 'company_admin', 'portal_admin'], smoke: { app: 'main' } },
  { id: 'portal-queue', label: 'Pending / Active Requests', path: '/portal/queue', shell: 'portal', section: 'Internal Requests', icon: 'inbox', moduleGate: 'support', roles: ['super_admin', 'company_admin', 'portal_admin'], smoke: { app: 'main' } },
  { id: 'portal-request-reports', label: 'Reports', path: '/portal/reports', shell: 'portal', section: 'Internal Requests', icon: 'file-spreadsheet', moduleGate: 'support', roles: ['super_admin', 'company_admin', 'portal_admin'], smoke: { app: 'main' } },
  ...
  { id: 'sales-deals', label: 'Deals', path: '/sales/deals', shell: 'main', section: 'Sales', icon: 'briefcase', group: 'Overview', moduleGate: 'sales', navShell: 'main', smoke: { app: 'main' } },
  { id: 'sales-deals-new', label: 'New Deal', path: '/sales/deals/new', shell: 'main', section: 'Sales', icon: 'plus', group: 'Overview', moduleGate: 'sales' },
  { id: 'sales-deals-detail', label: 'Deal Detail', path: '/sales/deals/:id', shell: 'main', section: 'Sales', icon: 'briefcase', group: 'Overview', moduleGate: 'sales' },
...
export const MAIN_ROUTE_CHROME: readonly PlatformRouteChromeDefinition[] = [
  ...
  { pattern: /^\/sales\/deals\/new/, title: 'New Deal', kicker: 'Create a new deal' },
  { pattern: /^\/sales\/deals\/[a-f0-9-]+/, title: 'Deal Detail', kicker: 'Full lifecycle view' },
  { pattern: /^\/sales\/deals/, title: 'Deals', kicker: 'Deal lifecycle management' },
  { pattern: /^\/sales\/orders/, title: 'Legacy Sales Orders', kicker: 'Redirects to Deals' },
